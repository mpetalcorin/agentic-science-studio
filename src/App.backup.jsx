...
export default function AgenticScienceStudio() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[radial-gradient(circle_at_top_left,#164e63,transparent_35%),radial-gradient(circle_at_top_right,#4c1d95,transparent_35%),linear-gradient(135deg,#020617,#0f172a_45%,#111827)] text-slate-100">
